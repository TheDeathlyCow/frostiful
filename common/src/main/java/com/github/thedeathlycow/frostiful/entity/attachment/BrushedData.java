...
public class BrushedData {
    public static final Codec<BrushedData> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(

            ).apply(instance, BrushedData::new)
    );
    ...
    public BrushedData(Animal provider) {
    ...
    public static InteractionResult interactWithMob(Animal animal, Player player, InteractionHand hand, InteractionResult base) {
        ...
        BrushedData component = FCardinalComponents.BRUSHABLE_COMPONENT.getNullable(animal);
