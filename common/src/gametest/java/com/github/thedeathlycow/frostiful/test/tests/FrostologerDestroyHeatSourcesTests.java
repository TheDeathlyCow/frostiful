...
public class FrostologerDestroyHeatSourcesTests {
    //region torch tests
    @GameTest(structure = "frostiful_test:frostologer_heat_source_test_template")
    ...
    private static void runDestroyHeatSourceTest(GameTestHelper context, BlockState toPlace, Block blockAtEnd) {
        ...
        Frostologer frostologer = context.spawn(FEntityTypes.FROSTOLOGER, pos.offset(1, 0, 1));
