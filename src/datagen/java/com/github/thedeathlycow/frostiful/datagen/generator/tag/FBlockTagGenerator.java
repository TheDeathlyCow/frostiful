...
public class FBlockTagGenerator extends FabricTagsProvider.BlockTagsProvider {
    public FBlockTagGenerator(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
