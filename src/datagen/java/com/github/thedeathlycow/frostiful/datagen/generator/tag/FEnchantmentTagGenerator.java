...
public class FEnchantmentTagGenerator extends FabricTagProvider<Enchantment> {
    public FEnchantmentTagGenerator(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
