...
public class FLootTableGenerator extends FabricEntityLootTableProvider {
    protected FLootTableGenerator(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
