...
public class FrostifulBlocks {
    ...
    public static final Block SUN_LICHEN = new SunLichenBlock(FabricBlockSettings.of(Material.REPLACEABLE_PLANT, MapColor.RED).noCollision().strength(0.2F).sounds(BlockSoundGroup.GLOW_LICHEN).ticksRandomly().nonOpaque().luminance(SunLichenBlock::getLuminance));
