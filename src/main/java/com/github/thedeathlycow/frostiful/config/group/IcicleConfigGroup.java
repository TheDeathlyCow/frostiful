...
public class IcicleConfigGroup extends ConfigItemGroup {
    ...
    public static final IntegerConfigItem ICICLE_COLLISION_FREEZE_AMOUNT = new IntegerConfigItem("icicle_collision_freeze_amount", 3000, TRANSLATE_BASE_STRING + "icicle_collision_freeze_amount", null, 0, Integer.MAX_VALUE);
