...
public class AttributeConfigGroup extends ConfigItemGroup {
    ...
    public static class BaseMaxFrost extends ConfigItemGroup {
        ...
        public static final DoubleConfigItem BASE = new DoubleConfigItem("base", 20.0D, TRANSLATE_BASE_STRING + "base", null, 0.0D, Double.POSITIVE_INFINITY);
        public static final DoubleConfigItem PLAYER = new DoubleConfigItem("player", 25.0D, TRANSLATE_BASE_STRING + "player", null, 0.0D, Double.POSITIVE_INFINITY);
