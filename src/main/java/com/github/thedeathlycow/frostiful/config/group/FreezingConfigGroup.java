...
public class FreezingConfigGroup extends ConfigItemGroup {
    ...
    public static final DoubleConfigItem BIOME_TEMPERATURE_MULTIPLIER = new DoubleConfigItem("biome_temperature_multiplier", 2.0, TRANSLATE_BASE_STRING + "biome_temperature_multiplier", null, 0.0, Double.POSITIVE_INFINITY);
    ...
    public static final IntegerConfigItem SUN_LICHEN_HEAT_PER_LEVEL = new IntegerConfigItem("sun_lichen_heat_per_level", 333, TRANSLATE_BASE_STRING + "sun_lichen_heat_per_level", null, 0, Integer.MAX_VALUE);
